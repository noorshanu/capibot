...
const EarnCard: React.FC<EarnCardProps> = ({ title, image, flag, profit }) => {
  return (
    <div className="grid grid-col-1  grid-col-1 w-full">
      <div className="group rounded-xl bg-[#000000] p-2 sm:p-3 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0 -8px 0px 0px #2196f3] flex justify-between">
        <div className="flex grid-cols-2 gap-3 w-full">
          ...
          <div className="flex flex-row w-full justify-between">
            ...
            <div className="flex items-center">
              {flag === true ? (
                <img src="/image/right.svg" alt="" className="w-8 h-8 ml-1" />
              ) : (
                <></>
              )}
            </div>
